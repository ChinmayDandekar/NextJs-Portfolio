    ...
    <>
      ...
      <main className='flex items-center text-dark dark:text-light w-full min-h-screen '>
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>As a skilled full-stack developer, I am dedicated to turning ideas into innovative web applications.
                Explore my latest projects and articles, showcasing my expertise in Next.js and web development.</p>
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/Chinmay_Dandekar_Resume.pdf" target='_blank'
                ...
                <Link href="/projects"
                  className='hidden ml-4 text-lg font-medium capitalize text-dark dark:text-light underline lg:block md:text-base'
                >Projects</Link>
              </div>
            </div>
          </div>
        ...
        <div className='absolute right-8 bottom-8 inline-block w-24  md:hidden'>
          <Image src={LightBulb} alt="Chinmay" className='w-full h-auto' />
        </div>
      </main>
