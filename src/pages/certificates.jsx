		...
		return (
			...
			'>
				...
				<div className='w-2/3 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
					...
					<p className=' my-2 font-medium text-dark/75 dark:text-light/75 sm:text-base'>{"Completed On " + date}</p>
					...
					<div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-x-24 sm:gap-x-0 '>
						...
						<div className='col-span-12'>
							...
							<Certificate
								...
								link="https://www.coursera.org/account/accomplishments/certificate/PN8RK5R73QAD"
								orgnization="Meta"
								img={certificate2}
